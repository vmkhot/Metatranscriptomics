# This heavy script is uses DESeq2 pipeline to do differential expression gene analysis on time-course data
# It includes a experiment design that could be customized
# It uses "lcfshrinkage" and type = "apeglm" and alpha = 0.005 to remove spurious reads
# It will write out all the "significant" differentialy expressed genes in from all time-points into one giant dataframe
# Refer to https://master.bioconductor.org/packages/release/workflows/vignettes/rnaseqGene/inst/doc/rnaseqGene.html#time-course-experiments
# and these forums for support:https://support.bioconductor.org/p/65676/ and https://support.bioconductor.org/p/9144558/

# This (probably highly inefficient) code is brought to you by Varada :)
...
# compile and write out all the dataframes
