# This script plots the clusters produced by Mfuzz in facets in a prettier way
# To produce the clusters and get cluster memberships: Metatranscriptomics\R-scripts\mfuzz_clustering.R
