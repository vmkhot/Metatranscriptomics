# This script is uses DESeq2 in default mode to explore the quality of count data and samples
# Refer to https://master.bioconductor.org/packages/release/workflows/vignettes/rnaseqGene/inst/doc/rnaseqGene.html#exploratory-analysis-and-visualization)
# By Varada Khot :)
